 ...
 * thumbnail'lar küçük + aktif olmayanlar sönük.
 */
export function FotoGaleri({ images, alt = 'İlan görseli' }: { images: string[]; alt?: string }) {
  ...
  return (
    <div className="space-y-3">
      {/* Ana görsel — sabit yükseklik (geniş ekranda devasa olmaz) */}
      <div className="group relative h-72 overflow-hidden rounded-xl bg-gray-100 sm:h-80">
